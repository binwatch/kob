...
public class RegisterServiceImpl implements RegisterService {
    ...
    public Map<String, String> register(String username, String password, String confirmedPassword) {
        ...
        if (username.length() > 100) {
            map.put("error_message", "the length of username cannot > 100");
            return map;
        }

        if (password.length() > 100) {
            map.put("error_message", "the length of password cannot > 100");
            return map;
        }
        ...
        String photo = "https://cdn.pixabay.com/photo/2020/02/06/11/32/avation-4823906_960_720.jpg";
